...
<template>
    <div
        class="flex flex-none items-center border-t border-gray-100 p-4 dark:border-gray-700/75"
    >
        <Menu as="div" class="relative inline-block w-full">
            <MenuButton
                class="inline-flex w-full items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-semibold text-gray-800 transition-colors hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700/50"
            >
                <Avatar
